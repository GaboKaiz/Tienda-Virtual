...
function insertarProducto($conn,$nombreproducto, $otrosproductos) {
// Consulta SQL para insertar datos
$sql = "INSERT INTO producto (NOMBREPRODUCTO, OTROSPRODUCTOS) VALUES (?, ?)";

// Preparar la consulta
$stmt = $conn->prepare($sql);
// Vincular parámetros
$stmt->bind_param("ss" ,$nombreproducto, $otrosproductos);
