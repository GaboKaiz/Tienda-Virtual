...
<body>
        ...
        <div class="container">
            <div class="columns">
                ...
                <a href="http://localhost/Gabriel/Entregable/html/Principal.html" class="styled-button">Regresar</a>
                    <h2 class="title">Datos Guardados - Colores</h2>
                    <div class="table-container"> <!-- Agrega una clase contenedora para la tabla -->
                        ...
                        <table class="table is-striped is-bordered"> <!-- Agrega clases de tabla Bulma -->
                            ...
                            <tbody>
                                ...
                                $sql = "SELECT IDCOLOR, CODIGOCOLOR, NOMBRECOLOR FROM color";
                                $result = $conn->query($sql);

                                if ($result->num_rows > 0) {
                                    while ($row = $result->fetch_assoc()) {
                                        echo "<tr>";
                                        echo "<td>" . $row["IDCOLOR"] . "</td>";
                                        echo "<td>" . $row["CODIGOCOLOR"] . "</td>";
                                        echo "<td>" . $row["NOMBRECOLOR"] . "</td>";
                                        echo "<td>";
                                        echo "<a href='http://localhost/Gabriel/ENTREGABLE/php/Color/EditarC.php?id=" . $row["IDCOLOR"] . "' class='button is-small is-info'>Editar</a> ";
                                        echo "<a href='#' class='button is-small is-danger' onclick='showConfirmationModal(" . $row["IDCOLOR"] . ");'>Eliminar</a>";
                                        echo "</td>";
                                        echo "</tr>";
                                    }
                                } else {
    ...
    <script>
        function showConfirmationModal(id) {
            ...
            document.getElementById('deleteButton').setAttribute('href', 'EliminarC.php?id=' + id);
        }
